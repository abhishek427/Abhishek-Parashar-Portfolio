    ...
    <Paper elevation={10} className="paper-size" id="skill">
      <Grid container justify="center" spacing={3}>
        ...
        <Grid item lg={5} md={5} sm={12} xs={12} className="side-spacing">
          ...
          <p className="heading-color">I have 1.5+ years of industry experience as a React and Front-end developer. And having Hands-on, comprehensive knowledge of agile methodologies and web-based applications, and Proven ability to work on multiple projects while meeting challenging deadlines.These are the following technology I know -</p>
        </Grid>
        <Grid item lg={5} md={5} sm={12} xs={12} className="side-spacing">
          {skillData.map((data) => {
            return (
