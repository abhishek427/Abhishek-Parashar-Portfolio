...
let cardData = [
  {
    ...
    subheading: (
      <span>
        Collaborating with{" "}
        <Typography component="span" variant="inherit" className="project-high-light-text">
          Actor Sonu Sood
        </Typography>
