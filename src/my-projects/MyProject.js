...
let cardData = [
  ...
  { key: 4, title: "Doctor/Pasents/Insurence", image: doctor, subheading: "In the nutshell in this Project,The Doctor prescribed the medication to the patient , and the insurance manager clear the bill of the medication.Techstack used- React js, Redux,Angular,React unit testing." },
